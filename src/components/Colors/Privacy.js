...
const Privacy = () => {
  return (
    <div className='border-t-2 border-[#6e6e73] py-6 flex justify-between basis-full md:py-[18px]'>
      <figure className='animate-[lock_2000ms_0ms_ease-in-out_forwards] w-[28px] h-[38px] bg-[length:224px_228px] bg-[url("https://www.apple.com/v/iphone-14-pro/c/images/overview/shared/icon_privacy__h1tub3ldvgae_medium_2x.png")]'></figure>
