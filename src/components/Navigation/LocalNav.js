    ...
    <nav
      className={
        toggleLocalbar
          ...
          : 'max-h-12 px-4 border-b border-[#424245] ease-in-out duration-500 delay-300 transition-all lg:max-w-screen-lg lg:mx-auto lg:my-0 lg:px-0 lg:max-h-13'
      }
    >
      ...
      <div
        className={
          toggleLocalbar
            ...
            : 'translate-y-[-30px] max-h-0 opacity-0 ease-in-out duration-500 overflow-hidden'
        }
      >
